...
VALUES
    ...
    ('pr_description_mode', 'full', 'string', 'select', 'review', 'PR 摘要模式', '摘要内容模式：summary_only 仅摘要 / full 摘要+统计+文件列表', '', 'full', '[{"label":"仅摘要","value":"summary_only"},{"label":"摘要+统计+文件","value":"full"}]', 41)
